...
export default (router: express.Router) => {
    ...
    router.patch('/users/makeUserEditor/:id', isAuthorized, isAdmin, makeUserEditor)
    router.patch('/users/removeUserEditor/:id', isAuthorized, isAdmin, removeUserEditor)
    router.patch('/users/makeUserAdmin/:id', isAuthorized, isAdmin, makeUserAdmin)
    ...
    router.get('/usersRole/editors', isAuthorized, isAdmin, getAllUsers)
